        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center bg-white p-4 p-md-5">
            <div class="w-100" style="max-width: 440px;">
                ...
                <div class="mb-5 text-end">
                    <h1 class="fw-bold mb-3 h2" style="color: var(--reefy-primary); font-family: 'Cairo', sans-serif;">إعادة تعيين كلمة المرور</h1>
                    <p class="text-muted">أدخل بريدك الإلكتروني وكلمة المرور الجديدة لاستعادة الوصول إلى حسابك.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <!-- Password -->
                    <div class="mb-4">
                        <label for="password" class="form-label fw-semibold mb-2 text-end d-block" style="color: #495057;">كلمة المرور الجديدة</label>
                        <div class="position-relative">
                            <input type="password" 
                                   class="form-control form-control-lg text-end border-0 ps-4 pe-5" 
                                   id="password" 
                    ...
                    <!-- Confirm Password -->
                    <div class="mb-5">
                        <label for="password_confirmation" class="form-label fw-semibold mb-2 text-end d-block" style="color: #495057;">تأكيد كلمة المرور</label>
                        <div class="position-relative">
                            <input type="password" 
                                   class="form-control form-control-lg text-end border-0 ps-4 pe-5" 
