<x-app-layout>
    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <!-- Resource Dynamics (CSS-based Visualization) -->
                                ...
                                <tr class="border-b border-gray-50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition">
                                    ...
                                    <td class="text-center">
                                        <div class="flex flex-col items-center gap-1">
                                            <span class="font-bold text-blue-600">{{ $weeklyWaterData[$index] ?? 0 }}</span>
                                            <div class="w-20 bg-gray-100 dark:bg-gray-700 h-1.5 rounded-full overflow-hidden">
                                                <div class="bg-blue-500 h-full" style="width: {{ min(100, ($weeklyWaterData[$index] ?? 0) / 10) }}%"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="flex flex-col items-center gap-1">
                                            <span class="font-bold text-green-600">{{ $weeklyFertData[$index] ?? 0 }}</span>
                                            <div class="w-20 bg-gray-100 dark:bg-gray-700 h-1.5 rounded-full overflow-hidden">
                                                <div class="bg-green-500 h-full" style="width: {{ min(100, ($weeklyFertData[$index] ?? 0) / 5) }}%"></div>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <!-- Life Cycle Snapshot (CSS-based progress bars) -->
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        ...
                        @foreach($stats as $stat)
                            <div>
                                ...
                                <div class="w-full bg-gray-100 dark:bg-gray-700 h-3 rounded-none overflow-hidden border border-gray-200 dark:border-gray-600">
                    ...
                    <div class="mt-8 p-4 bg-gray-50 dark:bg-gray-700/50 border border-dashed border-gray-200 dark:border-gray-600">
                        <p class="text-[10px] text-gray-500 leading-relaxed text-center italic">
                            {{ __('Automated analysis based on current crop stages in your farm.') }}
                        </p>
                    </div>
                </div>
            </div>
