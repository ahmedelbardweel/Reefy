...
Route::prefix('{lang?}')->where(['lang' => 'ar|en'])->name('api.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group( function () {
        ...
        Route::get('crops/suggestions', [CropController::class, 'getApiSuggestions'])->name('api.crops.suggestions_api');
        Route::delete('crops/images/{id}', [CropController::class, 'deleteImage']);
